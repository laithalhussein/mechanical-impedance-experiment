...
ierr_test2(ierr_test2_FF_idx) = nanmean(err_FF_all_sub_sign,1);
...
[b_est.avg.tst1, err_norm_cut.avg.tst1] = determine_triplet_LR_avg(res_tst1, ierr_tst1_norm, p_tst1(1));
...
b_est.tst1(err_norm_cut.tst1<0) = b_est.tst1(err_norm_cut.tst1<0) * -1;

%% now estimate learning rate on test2 data

[b_est.tst2, err_norm_cut.tst2, num_rem.tst2] = determine_triplet_LR(ILF_test2, norm_err.tst2, p_all.tst2(:,1) );

err_cutoff = 0.1;

%try estimating the learning based on the averaged data
[b_est.avg.tst2, err_norm_cut.avg.tst2] = determine_triplet_LR_avg(res_tst2, ierr_tst2_norm, p_tst2(1));
...
small_FF_err_idx = find(abs(err_norm_cut.avg.tst2(ierr_test2_FF_idx-num_rem.tst2)) < err_cutoff);

est_ar_FF(small_FF_err_idx) = NaN;
...
ILF_ar_EC_avg = nanmean( nanmedian(ILF.ar.err_EC,2))
