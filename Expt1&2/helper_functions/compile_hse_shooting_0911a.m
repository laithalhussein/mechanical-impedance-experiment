...
[b2,~,~,~,s2] = regress(ACI_training_vEC_cat, X1);
...
stiffness_effect_t1 = (ierr_training_cut*b2(2))';
%%% remove effects of stiffness
ACI_avg_training_ns = ACI_avg_training_vEC -  stiffness_effect_t1; %offset is first in b2
...
%first subtract effect of stiffness on individual subject basis

ACI_training_vEC_cut_ns = bsxfun(@(x,y) x-y, ACI_training_vEC_cut, stiffness_effect_t1 );
