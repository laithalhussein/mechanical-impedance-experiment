...
plot(ones(1,2).*exp_seq_all(1),yy, '--', 'color', grey);
plot(ones(1,2).*exp_seq_all(2),yy, '--', 'color', grey);
plot(ones(1,2).*exp_seq_all(3),yy, '--', 'color', grey);
plot(ones(1,2).*exp_seq_all(4),yy, '--', 'color', grey);
