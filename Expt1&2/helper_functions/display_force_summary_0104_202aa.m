function [LR_reg_sub_all, ar_sub_all, ideal_avg_sub_all, ideal_median_sub_all,...
    ar_gm, ideal_gm] = display_force_summary_0104_2022a(f, pert_fld, env_fld, sub_id, tt, show_median, show_error, show_PN, flip_sign)

%displays the average difference in positive and negative force profiles for each
